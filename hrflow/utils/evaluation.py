...
def parsing_evaluator(
    profile_list : t.List[t.Dict[str, t.Any]],
...
def fill_experience(
    ...
    colum_id_list = get_column_interval(
        EXPERIENCE_START_COLUMN_ID, 
        EXPERIENCE_END_COLUMN_ID
    )
    if show_progress:
...
def fill_education(
    ...
    """
    colum_id_list = get_column_interval(
        EDUCATION_START_COLUMN_ID,
        EDUCATION_END_COLUMN_ID
    )
    if show_progress:
